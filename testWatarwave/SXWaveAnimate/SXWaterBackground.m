...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.v2 = [[SXWaterBackgroundSub alloc]initWithFrame:CGRectMake(0 + kBGWidth/3 , kBGTop, kBGWidth/3, kBGHeight)];//-1
        self.v3 = [[SXWaterBackgroundSub alloc]initWithFrame:CGRectMake(0 + kBGWidth/3*2, kBGTop, kBGWidth/3, kBGHeight)];// -2
        [self addSubview:_v1];
        [self addSubview:_v2];
        [self addSubview:_v3];
    }
